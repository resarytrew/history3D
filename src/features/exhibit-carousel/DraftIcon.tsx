...
export function DraftIcon({ icon }: Pick<CollectionEntry, 'icon'>) {
  if (icon === 'musket') return <svg viewBox="0 0 60 44" aria-hidden="true"><path d="m4 30 13-5 8-4 31-9 1 3-32 10-7 5-12 7Z"/><path d="m22 23 2 6 6-2-2-6M24 21l-2-6 3-1 3 5"/></svg>
