...
export const shako1808Dimensions = {
  ...
  reconstruction: {
    ...
    badgeRelief: mm(0.95), badgeContactGap: mm(0.18), badgePocketBend: mm(18), yarnRadius: mm(0.20), seamUndulation: mm(0.12),
  ...
  topology: { radial: 128, patch: 40, cordRadial: 6, braidRadial: 8, braidSegments: 720, textureSize: 256 },
} as const
