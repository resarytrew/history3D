...
export const russianShako1808: Exhibit = {
  ...
  sources: [
    ...
    { id: 'archaeolog-one-flame', type: 'catalogue', title: 'Бляха-накладка «Гренада об одном огне» — фотография лицевой и обратной сторон',
      ...
      visitorTitle: 'Накладка «Гренада об одном огне»', visitorDescription: 'Фотография сохранившейся металлической накладки помогла уточнить форму и рельеф знака.', visitorAction: 'Посмотреть находку ↗' },
