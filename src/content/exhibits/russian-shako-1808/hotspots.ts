...
export const shakoHotspots: readonly Hotspot[] = [
  { id: 'shako-form', number: 1, label: 'Форма тульи', category: 'form',
  ...
  { id: 'shako-v', number: 2, label: 'V-образное усиление', category: 'construction',
  ...
  { id: 'shako-grenade', number: 3, label: 'Гренада об одном огне', category: 'decoration',
  ...
  { id: 'shako-repyok', number: 4, label: 'Репеёк', category: 'decoration',
  ...
  { id: 'shako-cord', number: 5, label: 'Этишкет', category: 'decoration',
    position: [-0.09, base + 0.068, 0.092], cameraTarget: [-0.04, base + 0.08, 0], cameraPosition: [-0.52, base + 0.17, 0.36],
  ...
  { id: 'shako-visor', number: 6, label: 'Козырёк', category: 'construction',
