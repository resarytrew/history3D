...
export const musketReconstruction: Exhibit['reconstruction'] = {
  ...
  summary: 'Внешний облик восстановлен по фотографии тульского ружья 1811 года из Музея отечественной военной истории. Уточнены поверхности и наружные детали; обмер и независимая экспертиза ещё не выполнены.',
  known: [
  ...
  uncertain: [
    ...
    { id: 'musket-fittings-depth', kind: 'RECONSTRUCTION', statement: 'Посадка обоймиц, крепления антабок, объём полки и губок, обёртка кремня и мелкий рельеф винтов переданы приблизительно: крупных планов и обмеров этих деталей пока нет.', sourceIds: ['user-musket-photo', 'pink-tula'], confidence: 'low', note: 'Правый вид: замок, средняя обоймица, скоба и дульная часть; типологические признаки: Пинк, PDF с. 4–5.' },
  ],
  unknown: [
  ...
  versions: [
    { version: '0.1.0', date: '2026-09-07', status: 'reconstruction', summary: 'Первая процедурная реконструкция наружного облика по правому виду экземпляра 1811 года. Форма, материалы, интерактивные детали; предположения выделены.' },
    { version: '0.2.0', date: '2026-09-07', status: 'reconstruction', summary: 'Уточнены посадка обоймиц, наружный рельеф замка, кремень и полка. Добавлены направленные волокна, различия блеска, локальные следы контакта и мягкая выставочная тень. Новые обмеры не получены.' },
  ],
}
